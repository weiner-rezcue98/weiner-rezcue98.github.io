...
// Consulta SQL para exibir os dados da tabela beneficios_fiscais
...
<head>
    ...
    <title>Relatório de Benefícios Fiscais</title>
    <style>
        body {
        ...
        <table id="beneficiosTable">
            <thead>
                <tr>
                    ...
                    <th>Título</th>
                    <th class="sortable" onclick="sortTable(2)">Ano</th>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . date('Y', strtotime($row['data'])) . "</td>";

                        echo "<td><a href='../admin/beneficios_fiscais/download.php?id=" . $row['id'] . "'>Download PDF</a></td>";
                        echo "</tr>";
                    }
                } else {
